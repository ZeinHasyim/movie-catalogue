import { createLikeMovieButtonTemplate, createUnlikedMovieButtonTemplate } from '../views/templates/template-creator';
...
const LikeButtonPresenter = {
  ...
  _renderLiked() {
    this._likeButtonContainer.innerHTML = createUnlikedMovieButtonTemplate();
